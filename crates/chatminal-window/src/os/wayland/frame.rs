...
use engine_color_types::SrgbaTuple;
use engine_font::{FontConfiguration, FontMetrics, GlyphInfo, RasterizedGlyph};
use engine_input_types::WindowDecorations;
    ...
    fn reshape_title(&mut self) -> Option<()> {
        ...
        let infos = font
            .shape(
                ...
                None,
                engine_bidi::Direction::LeftToRight,
                None,
                None,
            )
            .ok()?;
