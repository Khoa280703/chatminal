...
const CLS_NAME: &str = "ChatminalAppDelegate";
    ...
    unsafe {
        match config::configuration().window_close_confirmation {
            ...
            WindowCloseConfirmation::AlwaysPrompt => {
                ...
                let message_text = nsstring("Terminate Chatminal?");
                let info_text = nsstring("Detach and close all panes and terminate Chatminal?");
