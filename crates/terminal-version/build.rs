fn main() {
    ...
    // version number that we report in the terminal CLI help output.
    ...
    println!("cargo:rustc-env=ENGINE_TARGET_TRIPLE={}", target);
    println!("cargo:rustc-env=ENGINE_CI_TAG={}", ci_tag);
}
