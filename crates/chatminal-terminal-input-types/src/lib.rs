...
bitflags! {
    ...
    pub struct Modifiers: u16 {
        ...
        const LEFT_ALT = 1<<5;
        const RIGHT_ALT = 1<<6;
        /// This is a virtual modifier used by Chatminal
        const LEADER = 1<<7;
        const LEFT_CTRL = 1<<8;
...
impl KeyEvent {
    ...
    pub fn encode_kitty(&self, flags: KittyKeyboardFlags) -> String {
        ...
        // See: upstream pull request #4605
...
impl FromDynamic for IntegratedTitleButtonStyle {
    fn from_dynamic(
        ...
        _options: engine_dynamic::FromDynamicOptions,
        ...
        Self: Sized,
    {
        ...
        if let engine_dynamic::Value::String(string) = value {
            let style = match string.as_str() {
                "Windows" => Self::Windows,
                "Gnome" => Self::Gnome,
                "MacOsNative" if cfg!(target_os = "macos") => Self::MacOsNative,
                _ => {
                    return Err(engine_dynamic::Error::InvalidVariantForType {
            ...
            Err(engine_dynamic::Error::InvalidVariantForType {
