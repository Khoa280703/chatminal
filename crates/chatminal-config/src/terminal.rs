...
impl engine_term::TerminalConfiguration for TermConfig {
    ...
    fn canonicalize_pasted_newlines(&self) -> engine_term::config::NewlineCanon {
        match self.configuration().canonicalize_pasted_newlines {
            None => engine_term::config::NewlineCanon::default(),
            Some(NewlineCanon::None) => engine_term::config::NewlineCanon::None,
            Some(NewlineCanon::LineFeed) => engine_term::config::NewlineCanon::LineFeed,
            Some(NewlineCanon::CarriageReturn) => engine_term::config::NewlineCanon::CarriageReturn,
            Some(NewlineCanon::CarriageReturnAndLineFeed) => {
                engine_term::config::NewlineCanon::CarriageReturnAndLineFeed
            }
        }
    }
