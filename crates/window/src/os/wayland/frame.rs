...
use terminal_color_types::SrgbaTuple;
use terminal_font::{FontConfiguration, FontMetrics, GlyphInfo, RasterizedGlyph};
use terminal_input_types::WindowDecorations;
    ...
    fn reshape_title(&mut self) -> Option<()> {
        ...
        let infos = font
            .shape(
                ...
                None,
                terminal_bidi::Direction::LeftToRight,
                None,
                None,
            )
            .ok()?;
