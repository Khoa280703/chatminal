...
use terminal_input_types::{is_ascii_control, IntegratedTitleButtonStyle, KeyboardLedStatus};
...
const VIEW_CLS_NAME: &str = "ChatminalWindowView";
const WINDOW_CLS_NAME: &str = "ChatminalWindow";
...
impl WindowView {
    ...
    extern "C" fn did_resize(this: &mut Object, _sel: Sel, _notification: id) {
        ...
        if let Some(this) = Self::get_this(this) {
            ...
            // chatminal-desktop/src/termwindow/resize.rs.
            // upstream issue #3503
    ...
    fn define_class() -> &'static Class {
        ...
        unsafe {
            ...
            cls.add_method(
                ...
                Self::chatminal_perform_key_assignment
