...
impl Tab {
    ...
    pub fn adjust_pane_size(&self, direction: SessionDirection, amount: usize) {
    ...
    /// edge intersection.
    pub fn activate_pane_direction(&self, direction: SessionDirection) {
...
impl TabInner {
    ...
    fn adjust_pane_size(&mut self, direction: SessionDirection, amount: usize) {
        ...
        let split_direction = match direction {
            SessionDirection::Left | SessionDirection::Right => SplitDirection::Horizontal,
            SessionDirection::Up | SessionDirection::Down => SplitDirection::Vertical,
            SessionDirection::Next | SessionDirection::Prev => unreachable!(),
        };
        let delta = match direction {
            SessionDirection::Down | SessionDirection::Right => amount as isize,
            SessionDirection::Up | SessionDirection::Left => -(amount as isize),
            SessionDirection::Next | SessionDirection::Prev => unreachable!(),
        };
        loop {
            match cursor.go_up() {
    ...
    fn get_pane_direction(&mut self, direction: SessionDirection, ignore_zoom: bool) -> Option<usize> {
        ...
        if matches!(direction, SessionDirection::Next | SessionDirection::Prev) {
            ...
            return Some(if direction == SessionDirection::Next {
