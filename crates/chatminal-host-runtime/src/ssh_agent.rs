...
/// AgentProxy manages an agent.PID symlink in the Chatminal runtime
/// directory.
...
///
/// As a further complication, when a Chatminal proxy client is
...
impl AgentProxy {
    ...
    fn update_now(&self) {
        ...
        clients.sort_by(|a, b| {
            ...
            // in engine-mux-server-impl/src/sessionhandler.rs
