...
use crate::WorkspaceLayoutRegistry;
use terminal_emulator::{KeyCode, KeyModifiers, MouseEvent, TerminalSize};
...
impl SessionEngineShared {
    ...
    pub fn leaf_runtimes(&self) -> Arc<TerminalInstanceRuntimeRegistry> {
