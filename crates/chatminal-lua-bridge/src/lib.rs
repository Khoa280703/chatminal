use chatminal_runtime::{SessionTerminalHandle, SplitDirection, SplitRequest, SplitSize};
...
pub(crate) type PaneCachePolicy = chatminal_runtime::CachePolicy;
...
mod tests {
    ...
    use chatminal_runtime::{CachePolicy, LogicalLine};
