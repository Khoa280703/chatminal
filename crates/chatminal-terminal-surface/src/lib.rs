...
use core::cmp::min;
use engine_cell::color::ColorAttribute;
#[cfg(feature = "use_image")]
use engine_cell::image::ImageCell;
use engine_cell::{Cell, CellAttributes};
...
mod test {
    ...
    #[cfg(feature = "use_image")]
    use alloc::sync::Arc;
    use engine_cell::color::AnsiColor;
    #[cfg(feature = "use_image")]
    use engine_cell::image::ImageData;
    use engine_cell::{AttributeChange, Intensity};
