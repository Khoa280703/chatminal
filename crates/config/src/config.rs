...
impl Default for Config {
    fn default() -> Self {
        ...
        Config::from_dynamic(
            &dynamic::Value::Object(Default::default()),
            Default::default(),
        )
        .unwrap()
    }
...
impl Config {
    pub fn load() -> LoadedConfig {
        Self::load_with_overrides(&dynamic::Value::default())
    }
    ...
    pub fn load_with_overrides(overrides: &dynamic::Value) -> LoadedConfig {
    ...
    pub fn compute_extra_defaults(&self, config_path: Option<&Path>) -> Self {
        ...
        cfg.font_rules.push(StyleRule {
            italic: Some(true),
            intensity: Some(terminal_emulator::Intensity::Half),
        ...
        cfg.font_rules.push(StyleRule {
            italic: Some(false),
            intensity: Some(terminal_emulator::Intensity::Bold),
            font: bold,
            ..Default::default()
        });
        ...
        cfg.font_rules.push(StyleRule {
            italic: Some(true),
            intensity: Some(terminal_emulator::Intensity::Normal),
            font: italic,
            ..Default::default()
        });
    ...
    pub fn apply_cmd_defaults(
        ...
        cmd.env("TERM_PROGRAM_VERSION", crate::terminal_version());
    }
}
...
impl FromDynamic for BoldBrightening {
    fn from_dynamic(
        value: &dynamic::Value,
        options: dynamic::FromDynamicOptions,
        ...
        match String::from_dynamic(value, options) {
            Ok(s) => match s.as_str() {
                ...
                s => Err(dynamic::Error::Message(format!(
