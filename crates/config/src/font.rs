        ...
        match value {
            ...
            other => {
                if let Some(value) = value.coerce_unsigned() {
                    ...
                    Err(dynamic::Error::NoConversion {
...
pub struct StyleRule {
    ...
    /// "Half".
    pub intensity: Option<terminal_emulator::Intensity>,
    ...
    /// "Double".
    pub underline: Option<terminal_emulator::Underline>,
    ...
    /// a value that matches this rule.
    pub blink: Option<terminal_emulator::Blink>,
