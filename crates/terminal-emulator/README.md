# chatminal-terminal-emulator

This crate provides the core of the virtual terminal emulator implementation
used by [Chatminal](https://github.com/Khoa280703/chatminal). The home for this
crate is in the Chatminal repo and development is tracked at
