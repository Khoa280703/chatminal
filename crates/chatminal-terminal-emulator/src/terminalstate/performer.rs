...
impl<'a> Performer<'a> {
    ...
    fn control(&mut self, control: ControlCode) {
        ...
        match control {
            ...
            // Chatminal only supports UTF-8, so does not support the
    ...
    fn csi_dispatch(&mut self, csi: CSI) {
        ...
        match csi {
            ...
            CSI::Cursor(engine_escape_parser::csi::Cursor::Left(n)) => {
    ...
    fn osc_dispatch(&mut self, osc: OperatingSystemCommand) {
        ...
        match osc {
            ...
            OperatingSystemCommand::ChangeDynamicColors(first_color, colors) => {
                ...
                use engine_escape_parser::osc::DynamicColorNumber;
            ...
            OperatingSystemCommand::ConEmuProgress(prog) => {
                use engine_escape_parser::osc::Progress as TProg;
                let prog = match prog {
