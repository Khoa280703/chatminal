...
- `crates/chatminal-host-runtime/src/domain.rs` — added `#[deprecated]` + `#[allow(deprecated)]` on `split_pane` trait default method (line 72)
...
### Issues Encountered
- Deprecation warning caller was `lib.rs:1253`, not `domain.rs` impl — added `#[allow(deprecated)]` at that site
