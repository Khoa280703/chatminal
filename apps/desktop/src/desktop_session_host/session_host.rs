...
impl DesktopSessionHost {
    ...
    fn sync_render_state_for_runtime(&self, state: &SessionRuntimeState) {
        ...
        let pane_size = self
            ...
            .get(&runtime_id)
            .copied()
            .unwrap_or_else(terminal_emulatorinal_size_default);
    ...
    fn build_render_state(
        &self,
        runtime_id: RuntimeId,
        layout: &runtime::execution::SessionLayoutSnapshot,
    ...
    pub(crate) fn resize_runtime_entry_split(
        ...
        _split_index: usize,
        _delta: isize,
    ) -> Option<runtime::RuntimeEntrySplitInfo> {
...
fn terminal_emulatorinal_size_default() -> TerminalSize {
    TerminalSize {
        rows: 24,
        cols: 80,
        pixel_width: 0,
