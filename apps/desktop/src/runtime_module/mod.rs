...
pub fn desktop_prepare_workspace_layout(size: terminal_emulator::TerminalSize) -> bool {
...
pub fn desktop_resize_visible_sessions(size: terminal_emulator::TerminalSize) -> bool {
...
fn terminal_size_for_layout_session(
    ...
    size: terminal_emulator::TerminalSize,
    session_id: &str,
) -> terminal_emulator::TerminalSize {
