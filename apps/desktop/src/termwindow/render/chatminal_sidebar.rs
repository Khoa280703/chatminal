...
impl crate::TermWindow {
    ...
    fn sidebar_text_font(&self) -> anyhow::Result<std::rc::Rc<terminal_font::LoadedFont>> {
    ...
    fn sidebar_header_font(&self) -> anyhow::Result<std::rc::Rc<terminal_font::LoadedFont>> {
    ...
    fn build_chatminal_sidebar_header_row(
        &mut self,
        body_font: &std::rc::Rc<terminal_font::LoadedFont>,
        title_font: &std::rc::Rc<terminal_font::LoadedFont>,
        body_width: f32,
        text: LinearRgba,
        muted: LinearRgba,
        hover_bg: LinearRgba,
    ...
    fn build_chatminal_sidebar_tree_row_elements(
        ...
        body_font: &std::rc::Rc<terminal_font::LoadedFont>,
        status_font: &std::rc::Rc<terminal_font::LoadedFont>,
        text: LinearRgba,
        muted: LinearRgba,
        accent: LinearRgba,
