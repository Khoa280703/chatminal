...
pub fn usage() -> &'static str {
  ...
  chatminal-app dashboard [preview_lines] [cols] [rows] [max_terminal_preview_lines]
  chatminal-app dashboard-watch [seconds] [refresh_ms] [preview_lines] [cols] [rows] [max_terminal_preview_lines]
  chatminal-app dashboard-tui [refresh_ms] [preview_lines] [cols] [rows] [max_terminal_preview_lines]
