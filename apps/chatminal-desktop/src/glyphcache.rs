...
use engine_font::units::*;
use engine_font::{FontConfiguration, GlyphInfo, LoadedFont, LoadedFontId};
use engine_term::Underline;
use euclid::num::Zero;
use image::{
...
impl GlyphCache {
    ...
    fn load_glyph(
        ...
        // can happen somehow; see upstream issue #1042
        ...
        match &*handle.h {
            ...
            ImageDataType::AnimRgba8 {
                ...
                if frames.len() > 1 {
                    ...
                    // frame duration that Chatminal can use when rendering.
