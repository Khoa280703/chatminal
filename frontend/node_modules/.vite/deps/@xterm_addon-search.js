...
function mt(r4, e, t = 0, n = r4.length) {
  let i = t, s = n;
  for (; i < s; ) {
...
var V = class V2 {
  ...
  findLastMaxBy(e) {
    let t, n = true;
    return this.iterate((i) => ((n || Qe.isGreaterThan(e(i, t))) && (n = false, t = i), true)), t;
  }
};
V.empty = new V((e) => {
});
...
var de = class de2 {
  ...
  computeLeakingDisposables(e = 10, t) {
    ...
    if (t) n = t;
      ...
      let u = /* @__PURE__ */ new Map(), p = [...this.livingDisposables.values()].filter((v) => v.source !== null && !this.getRootParent(v, u).isSingleton);
      if (p.length === 0) return;
      let T = new Set(p.map((v) => v.value));
      if (n = p.filter((v) => !(v.parent && T.has(v.parent))), n.length === 0) throw new Error("There are cyclic diposable chains!");
    }
    if (!n) return;
    function i(u) {
      function p(v, I) {
        for (; v.length > 0 && I.some((E) => typeof E == "string" ? E === v[0] : v[0].match(E)); ) v.shift();
      }
      let T = u.source.split(`
`).map((v) => v.trim().replace("at ", "")).filter((v) => v !== "");
      return p(T, ["Error", /^trackDisposable \(.*\)$/, /^DisposableTracker.trackDisposable \(.*\)$/]), T.reverse();
    }
    let s = new ce();
    for (let u of n) {
      let p = i(u);
      for (let T = 0; T <= p.length; T++) s.add(p.slice(0, T).join(`
`), u);
    }
    n.sort($e((u) => u.idx, Be));
    let a = "", h = 0;
    for (let u of n.slice(0, e)) {
      ...
      for (let v = 0; v < p.length; v++) {
        let I = p[v];
        I = `(shared with ${s.get(p.slice(0, v + 1).join(`
`)).size}/${n.length} leaks) at ${I}`;
        let S = s.get(p.slice(0, v).join(`
`)), D = Xe([...S].map((x) => i(x)[v]), (x) => x);
        delete D[p[v]];
        for (let [x, J] of Object.entries(D)) T.unshift(`    - stacktraces of ${J.length} other leaks continue with ${x}`);
        T.unshift(I);
      }
      a += `
...
if (Tt) {
  let r4 = "__is_disposable_tracked__";
  vt(new class {
    trackDisposable(e) {
...
function pe(r4) {
  return K == null ? void 0 : K.trackDisposable(r4), r4;
}
function fe(r4) {
  K == null ? void 0 : K.markAsDisposed(r4);
}
function te(r4, e) {
  K == null ? void 0 : K.setParent(r4, e);
}
function bt(r4, e) {
  if (K) for (let t of r4) K.setParent(t, e);
}
function Q(r4) {
  if (Le.is(r4)) {
    let e = [];
...
var F = class {
  ...
  set value(e) {
    var _a4;
    this._isDisposed || e === this._value || ((_a4 = this._value) == null ? void 0 : _a4.dispose(), e && te(e, this), this._value = e);
  }
  clear() {
    this.value = void 0;
  }
  dispose() {
    var _a4;
    this._isDisposed = true, fe(this), (_a4 = this._value) == null ? void 0 : _a4.dispose(), this._value = void 0;
  }
  clearAndLeak() {
    let e = this._value;
...
((re) => {
  ...
  function e(d) {
    if (yt) {
      let { onDidAddListener: o } = d, c = ne.create(), l = 0;
      d.onDidAddListener = () => {
        ++l === 2 && (console.warn("snapshotted emitter LIKELY used public and SHOULD HAVE BEEN created with DisposableStore. snapshotted here"), c.print()), o == null ? void 0 : o();
      };
    }
  }
  function t(d, o) {
  ...
  function T(d, o) {
    ...
    o || e(l);
    let f = new C(l);
    return o == null ? void 0 : o.add(f), f.event;
  }
  function v(d, o) {
  ...
  function I(d, o, c = 100, l = false, f = false, b, g) {
    let w, R, U, se = 0, Z, Ve = { leakWarningThreshold: b, onWillAddFirstListener() {
      ...
      f && se > 0 && (Z == null ? void 0 : Z());
    }, onDidRemoveLastListener() {
      Z = void 0, w.dispose();
    } };
    g || e(Ve);
    let oe = new C(Ve);
    return g == null ? void 0 : g.add(oe), oe.event;
  }
  re.debounce = I;
  function E(d, o = 0, c) {
  ...
  function x(d, o = false, c = [], l) {
    ...
    l && l.add(b);
    let g = () => {
      f == null ? void 0 : f.forEach((R) => w.fire(R)), f = null;
  ...
  class ct {
    constructor(o, c) {
      ...
      c || e(l), this.emitter = new C(l), c && c.add(this.emitter);
    }
    beginUpdate(o) {
      this._counter++;
    }
...
var It = 2;
var Dt = (r4, e) => {
  if (r4 instanceof G) e(r4);
  else for (let t = 0; t < r4.length; t++) {
    let n = r4[t];
    n && e(n);
  }
};
...
var C = class {
  constructor(e) {
    var _a4, _b, _c, _d;
    this._size = 0;
    this._options = e, this._leakageMon = nt > 0 || ((_a4 = this._options) == null ? void 0 : _a4.leakWarningThreshold) ? new Ae((e == null ? void 0 : e.onListenerError) ?? le, ((_b = this._options) == null ? void 0 : _b.leakWarningThreshold) ?? nt) : void 0, this._perfMon = ((_c = this._options) == null ? void 0 : _c._profName) ? new Oe(this._options._profName) : void 0, this._deliveryQueue = (_d = this._options) == null ? void 0 : _d.deliveryQueue;
  }
  dispose() {
    var _a4, _b, _c, _d;
    if (!this._disposed) {
  ...
  get event() {
    return this._event ?? (this._event = (e, t, n) => {
      ...
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        return (((_a4 = this._options) == null ? void 0 : _a4.onListenerError) || le)(T), k.None;
      }
      if (this._disposed) return k.None;
      t && (e = e.bind(t));
      let i = new G(e), s, a;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (i.stack = ne.create(), s = this._leakageMon.check(i.stack, this._size + 1)), tt && (i.stack = a ?? ne.create()), this._listeners ? this._listeners instanceof G ? (this._deliveryQueue ?? (this._deliveryQueue = new Ne()), this._listeners = [this._listeners, i]) : this._listeners.push(i) : ((_c = (_b = this._options) == null ? void 0 : _b.onWillAddFirstListener) == null ? void 0 : _c.call(_b, this), this._listeners = i, (_e2 = (_d = this._options) == null ? void 0 : _d.onDidAddFirstListener) == null ? void 0 : _e2.call(_d, this)), this._size++;
      let h = A(() => {
        ve == null ? void 0 : ve.unregister(h), s == null ? void 0 : s(), this._removeListener(i);
      });
...
`).trim(), p = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(u);
        ve.register(h, (p == null ? void 0 : p[2]) ?? u, h);
      }
      return h;
    }), this._event;
  }
  ...
  _deliver(e, t) {
    var _a4;
    if (!e) return;
    let n = ((_a4 = this._options) == null ? void 0 : _a4.onListenerError) || le;
    if (!n) {
      e.value(t);
      return;
    }
  ...
  fire(e) {
    var _a4, _b, _c, _d;
    if (((_a4 = this._deliveryQueue) == null ? void 0 : _a4.current) && (this._deliverQueue(this._deliveryQueue), (_b = this._perfMon) == null ? void 0 : _b.stop()), (_c = this._perfMon) == null ? void 0 : _c.start(this._size), this._listeners) if (this._listeners instanceof G) this._deliver(this._listeners, e);
    else {
...
var O;
var _a;
typeof W.vscode < "u" && typeof W.vscode.process < "u" ? O = W.vscode.process : typeof process < "u" && typeof ((_a = process == null ? void 0 : process.versions) == null ? void 0 : _a.node) == "string" && (O = process);
var _a2;
var ot = typeof ((_a2 = O == null ? void 0 : O.versions) == null ? void 0 : _a2.electron) == "string";
var Ot = ot && (O == null ? void 0 : O.type) === "renderer";
var _a3;
if (typeof O == "object") {
...
function xe(r4, e = 0, t) {
  let n = setTimeout(() => {
    ...
    clearTimeout(n), t == null ? void 0 : t.deleteAndLeak(i);
  });
  return t == null ? void 0 : t.add(i), i;
}
var jt;
var Ue;
(function() {
  typeof globalThis.requestIdleCallback != "function" || typeof globalThis.cancelIdleCallback != "function" ? Ue = (r4, e) => {
    at(() => {
      if (t) return;
      let n = Date.now() + 15;
    ...
    let n = r4.requestIdleCallback(e, typeof t == "number" ? { timeout: t } : void 0), i = false;
    return { dispose() {
      i || (i = true, r4.cancelIdleCallback(n));
    } };
  }, jt = (r4) => Ue(globalThis, r4);
})();
var qt;
((t) => {
  async function r4(n) {
...
var Ie = class extends k {
  ...
  getLineFromCache(t) {
    var _a4;
    return (_a4 = this._linesCache) == null ? void 0 : _a4[t];
  }
  setLineInCache(t, n) {
  ...
  translateBufferLineToStringWithWrap(t, n) {
    ...
    for (; a; ) {
      ...
      if (u && h) {
        ...
        T && T.getCode() === 0 && T.getWidth() === 1 && ((_a4 = h.getCell(0)) == null ? void 0 : _a4.getWidth()) === 2 && (p = p.slice(0, -1));
      }
...
var Ee = class {
  ...
  _findInLine(e, t, n = {}, i = false) {
    ...
    if ((_a4 = this._terminal.buffer.active.getLine(s)) == null ? void 0 : _a4.isWrapped) {
      if (i) {
...
var ut = class extends k {
  constructor(t) {
    ...
    this._highlightLimit = (t == null ? void 0 : t.highlightLimit) ?? 1e3;
  }
  get onDidChangeResults() {
  ...
  _updateMatches() {
    var _a4;
    this._highlightTimeout.clear(), this._state.cachedSearchTerm && ((_a4 = this._state.lastSearchOptions) == null ? void 0 : _a4.decorations) && (this._highlightTimeout.value = xe(() => {
  ...
  clearDecorations(t) {
    var _a4;
    this._resultTracker.clearSelectedDecoration(), (_a4 = this._decorationManager) == null ? void 0 : _a4.clearHighlightDecorations(), this._resultTracker.clearResults(), t || this._state.clearCachedTerm();
  }
  ...
  _highlightAllMatches(t, n) {
    ...
    for (; a && ((s == null ? void 0 : s.row) !== a.row || (s == null ? void 0 : s.col) !== a.col) && !(i.length >= this._highlightLimit); ) s = a, i.push(s), a = this._engine.find(t, s.col + s.term.length >= this._terminal.cols ? s.row + 1 : s.row, s.col + s.term.length >= this._terminal.cols ? 0 : s.col + 1, n);
  ...
  _findNextAndSelect(t, n, i) {
    ...
    return this._selectResult(s, n == null ? void 0 : n.decorations, i == null ? void 0 : i.noScroll);
  }
  findPrevious(t, n, i) {
    if (!this._terminal || !this._engine) throw new Error("Cannot use addon until it has been loaded");
    this._state.lastSearchOptions = n, this._state.shouldUpdateHighlighting(t, n) && this._highlightAllMatches(t, n);
